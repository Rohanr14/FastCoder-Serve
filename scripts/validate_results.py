...
def main() -> int:
    ...
    print(f"  serving backend: {result.software.serving_backend}")
    print(f"  vLLM version: {result.software.vllm_version}")
    print(f"  speculative method: {result.speculation.method}")
